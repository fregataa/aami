...
The Config Server is a REST API service that manages monitoring infrastructure configuration. It implements a hierarchical group-based policy inheritance system for targets, alerts, and check settings.
...
- [ ] CheckSetting - Domain ✅, Repository ⚠️ (needs ORM model), Service ✅, Handler ✅, Router ✅
